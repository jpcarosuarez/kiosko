  ...
  renderForms = () => {
    return this.state.isLoggedIn
      ? <div key='a' className='form'>
        <label>Llamar a </label>
        <input value={this.state.userToCall} type="text" onChange={e => this.setState({ userToCall: e.target.value })} />
        <button onClick={this.onStartCallClicked} id="call-btn" className="btn btn-primary">Llamar</button>
      ...
      : <div key='b' className='form'>
        ...
        <button onClick={this.onLoginClicked} id="login-btn" className="btn btn-primary">Ingresar</button>
